...
public interface IClock {
	...
	/**
	 * Synchronizes two clocks. Note that this method modifies the clock
	 * received as parameter, NOT the instance of the clock that receives the
	 * call.
	 * 
	 * @param clock
	 *            The clock that is to be synchronized.
	 */
	public void synchronize (IClock clock);
	
	/**
	 * Returns a string of the time of the clock in an appropriate format.
	 * 
